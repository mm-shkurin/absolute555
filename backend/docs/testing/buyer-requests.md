...
### TC-BRQ-001 — Покупатель открывает заявку
...
### TC-BRQ-002 — Лимит открытых заявок
...
### TC-BRQ-003 — Чужую заявку закрыть нельзя
...
### TC-BRQ-004 — Лента спроса только для поставщика
...
### TC-BRQ-005 — Отклик поставщика открывает переписку
...
### TC-BRQ-006 — Повторный отклик правит первый
...
### TC-BRQ-008 — Отклик на закрытую заявку
...
### TC-BRQ-009 — Отклик не-поставщика и валидация тел
