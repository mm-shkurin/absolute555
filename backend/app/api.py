...
from app.features.account.api import account_profile, admin_console, role, role_request, user
...
api_router.include_router(account_profile.profile_router, prefix="/user", tags=["user"])
