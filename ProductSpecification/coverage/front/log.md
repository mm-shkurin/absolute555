...
2026-09-14 18:00 | #5 | suite | front | tsc exit 0; Test Files 58 passed; Tests 329 passed | lines 46.51% (+4.6), branches 40.95%, functions 41.22%
2026-09-14 18:01 | #5 | commit| listing | test(frontend): покрыть страницу объявления сценариями смотрящих |
