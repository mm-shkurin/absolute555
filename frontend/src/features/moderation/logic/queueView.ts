...
// Причины отказа заданы списком: свободный текст у каждого модератора звучал бы по-своему,
// а продавец должен видеть одну и ту же формулировку за одно и то же нарушение.
export const REJECTION_REASONS = [
  'Видны номер или лицо',
  'Фото не той машины',
  'Цена-приманка',
  'Мало фотографий',
  'Контакты в описании',
