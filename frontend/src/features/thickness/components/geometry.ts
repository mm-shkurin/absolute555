...
const SIDE_ZONES: Zone[] = [
  ...
  { code: 'trunk_lid', d: 'M366 132 L392 133 L500 140 L500 148 L366 140 Z' },
  { code: 'front_left_fender', d: 'M28 176 L28 150 Q28 138 44 136 L120 134 L120 176 Z' },
  { code: 'front_left_door', d: 'M132 134 L252 134 L252 176 L132 176 Z' },
  { code: 'rear_left_door', d: 'M262 134 L364 134 L364 176 L262 176 Z' },
  { code: 'rear_left_fender', d: 'M366 142 L500 150 Q500 168 500 176 L366 176 Z' },
  { code: 'front_bumper', d: 'M22 158 L28 158 L28 178 L22 178 Z' },
  { code: 'rear_bumper', d: 'M500 156 L508 158 L508 178 L500 178 Z' },
]
...
const FRONT_ZONES: Zone[] = [
  ...
  { code: 'front_bumper', d: 'M596 152 L854 152 L854 176 L596 176 Z' },
  { code: 'front_left_fender', d: 'M596 130 L622 130 L622 152 L596 152 Z' },
  { code: 'front_right_fender', d: 'M828 130 L854 130 L854 152 L828 152 Z' },
]
...
const REAR_ZONES: Zone[] = [
  { code: 'trunk_lid', d: 'M622 312 L648 278 L802 278 L828 312 Z' },
  { code: 'rear_bumper', d: 'M596 368 L854 368 L854 392 L596 392 Z' },
  { code: 'rear_left_fender', d: 'M596 346 L622 346 L622 368 L596 368 Z' },
  { code: 'rear_right_fender', d: 'M828 346 L854 346 L854 368 L828 368 Z' },
]
...
const TOP_ZONES: Zone[] = [
  ...
  { code: 'trunk_lid', d: 'M340 314 L470 320 L470 440 L340 446 Z' },
  { code: 'front_left_fender', d: 'M126 290 L194 290 L194 304 L126 300 Z' },
  { code: 'front_right_fender', d: 'M126 456 L194 456 L194 470 L126 466 Z' },
  { code: 'front_left_door', d: 'M196 288 L266 288 L266 312 L196 312 Z' },
  { code: 'front_right_door', d: 'M196 448 L266 448 L266 472 L196 472 Z' },
  { code: 'rear_left_door', d: 'M268 287 L338 286 L338 312 L268 312 Z' },
  { code: 'rear_right_door', d: 'M268 448 L338 448 L338 473 L268 473 Z' },
  { code: 'rear_left_fender', d: 'M340 286 L410 288 L410 312 L340 312 Z' },
  { code: 'rear_right_fender', d: 'M340 448 L410 448 L410 472 L340 472 Z' },
  { code: 'front_bumper', d: 'M64 340 Q64 300 100 291 L120 296 L120 464 L100 469 Q64 460 64 420 Z' },
  { code: 'rear_bumper', d: 'M472 318 L494 336 L494 424 L472 442 Z' },
]
